    ...
    while True:
        ...
        try:
            ...
            if opc in p_opcs:
                ...
                print(
                    'ERROR! debes ingresar una opcion valida, opciones validas(1,2,3,4,5)!')
...
def registrar_pedido():
    ...
    while True:
        try:
            ...
            if rut >= 1000000 and rut <= 99999999:
                ...
                print(
                    'ERROR! el rut ingresado debe contener al menos 7 digitos y no sobrepasar los 8 digitos!')
            limpiar_esperar_screen()
        except:
    ...
    while True:
        try:
            comuna_tipo = int(
                input('Ingrese una comuna (1: Santiago 2: Colina 3: Pirque): '))
            if comuna_tipo in (1, 2, 3):
                ...
                print(
                    "ERROR! debe ingresar una comuna valida, opciones de comunas validas(1,2,3)!")
            limpiar_esperar_screen()
        except:
            print('ERROR! debe ingresar un numero entero!')
    ...
    while True:
        mensaje = str(
            input('Desea llevar un gas de 5 kilos, Ingrese ("S"si"N":no): '))
                ...
                while True:
                    try:
                        ...
                        if cant_cilindro_5 >= 1:
                            ...
                            print(
                                'ERROR! debe ingresar una cantidad valida, la cantidad debe ser mayor o igual a 1!')
                        limpiar_esperar_screen()
                    except:
                        print('ERROR! debe ingresar un numero entero!')
                break
    ...
    while True:
        mensaje = str(
            input('Desea llevar un gas de 15 kilos, Ingrese ("S"si"N":no): '))
        if mensaje.upper() in ("S", "N"):
            if mensaje.upper() == "S":
                while True:
                    try:
                        cant_cilindro_15 = int(
                            input('Ingrese la cantidad de cilindros: '))
    ...
    if cant_cilindro_15 >= 1 or cant_cilindro_5 >= 1:
        pedido_5kg = cant_cilindro_5 * precio_cilindro_5
        pedido_15kg = cant_cilindro_15 * precio_cilindro_15
        precio_total_ped = pedido_5kg + pedido_15kg
        pedido = [rut, nombre, direccion, comunas[comuna_tipo-1],
                  cant_cilindro_5, cant_cilindro_15, precio_total_ped]

        pedidos.append(pedido)
        print('PEDIDO REGISTRADO!')
        limpiar_esperar_screen()
    else:
        if cant_cilindro_5 == 0 and cant_cilindro_15 == 0:
            print('El cliente no solicito ningun galon de gas!')
            limpiar_esperar_screen()
...
def listar_todos_pedidos():
    ...
    if len(pedidos) >= 1:
        while True:
            ...
            for p in pedidos:
                print(
                    f"\t RUT:{p[0]}\t Cliente:{p[1]}\t Direccion:{p[2]}\t Comuna:{p[3]}\t Cant.5kg:{p[4]}\t Cant.15kg:{p[5]}\t Total:{p[6]}\n")
            opc_salir = str(
                input('Deseas salir? Ingrese ("S":SALIR "N":redirigir pedidos): '))
            if opc_salir.upper() in ("S", "N"):
                ...
                print(
                    'ERROR! debe ingresar una opcion valida, opciones valida ("S" o "N")!')
    else:
...
def buscar_pedido_rut():
    ...
    if len(pedidos) >= 1:
        while True:
            try:
                rut = int(
                    input('Ingrese el rut para buscar el pedido (Sin puntos ni guion): '))
                if rut >= 1000000 and rut <= 99999999:
                    print('Buscando.')
                    limpiar_esperar_screen()
                    for x in pedidos:
...
def imprimir_ruta_csv():
    ...
    if len(pedidos) >= 1:
        while True:
            try:
                comuna = int(
                    input('Ingrese la comuna que desea repartir (1:Santiago 2:Colina 3:Pirque): '))
                if comuna in (1, 2, 3):
                    print('comuna ingresada correctamente!')
                    limpiar_esperar_screen()
                    break
                    ...
                    print(
                        'ERROR! debe ingresar una comuna valida, comunas validas(1,2,3)!')
                limpiar_esperar_screen()
            except:
                print('ERROR! debe ingresar un numero entero!')
        while True:
